...
using EShopOnAbp.CustomerService.Blazor.Server.Host.Menus;
...
public class CustomerServiceBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(CustomerServiceDomainModule).Assembly,
                typeof(CustomerServiceDomainSharedModule).Assembly,
                typeof(CustomerServiceApplicationModule).Assembly,
                typeof(CustomerServiceApplicationContractsModule).Assembly,
                typeof(CustomerServiceBlazorHostModule).Assembly
            );
        });
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/EShopOnAbp.CustomerService.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<CustomerServiceBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(CustomerServiceBlazorHostModule).Assembly;
        });
